...
`https://victoryfxtech.github.io/your-repo-name/`

## Featured Live Projects

| Project | Description | Live Link |
|---------|-------------|-----------|
| **Nexa Business** | Responsive business landing page | [View live site](https://victoryfxtech.github.io/business-landing-page/) |
| **Luma Store** | E-commerce storefront with cart | [View live site](https://victoryfxtech.github.io/ecommerce-store/) |
| **Professional Portfolio** | Clean personal portfolio concept | [View live site](https://victoryfxtech.github.io/professional-website/) |
...
### After Deployment — Update Links (optional)

Once live, you can change the project links from relative paths to full GitHub Pages URLs if you prefer absolute links:

```
https://victoryfxtech.github.io/YOUR-REPO-NAME/projects/business-landing-page/
https://victoryfxtech.github.io/YOUR-REPO-NAME/projects/ecommerce-store/
https://victoryfxtech.github.io/YOUR-REPO-NAME/projects/professional-website/
```
